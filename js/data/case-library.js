...
export const CASE_LIBRARY = [
  ...
  C('ChamSys MQ100 -CAB', 'Licht', 71, 67, 29, 'CAB', 'ChamSys'),
  C('ChamSys MQ500 -CAB', 'Licht', 93, 66, 30, 'CAB', 'ChamSys'),
  C('ChamSys Wing Compact -CAB', 'Licht', 60, 35, 20, 'CAB', 'ChamSys'),
  C('gMA2 FS -CAB', 'Licht', 138, 32, 93, 'CAB'),
  C('gMA2 Light -CAB', 'Licht', 100, 32, 93, 'CAB'),
  C('Astera AX5 -BBM', 'Licht', 75, 62, 59, 'BBM', 'Astera'),
  C('MagicBlade -BBM', 'Licht', 138, 60, 55, 'BBM', 'Ayrton'),
  C('Magicblade wide -CAB', 'Licht', 122, 67, 55, 'CAB', 'Ayrton'),
  C('Sharpy x2 gross -CAB', 'Licht', 100, 60, 70, 'CAB', 'Clay Paky'),
  C('Sharpy x2 klein -CAB', 'Licht', 100, 48, 70, 'CAB', 'Clay Paky'),
  C('B-Eye K20 x2 -Jäger', 'Licht', 116, 54, 80, 'Jäger', 'Clay Paky'),
  C('B-Eye K10 x4 -CAB', 'Licht', 120, 60, 70, 'CAB', 'Clay Paky'),
  C('ETC S4 x6 -CAB', 'Licht', 90, 60, 90, 'CAB', 'ETC'),
  ...
  C('X4-Bar 20 -BBM', 'Licht', 130, 60, 58, 'BBM', 'GLP'),
  C('JDC-1 lang -Motion', 'Licht', 118, 55, 50, 'Motion', 'GLP'),
  C('JDC-1 Cube (4) -RentALL', 'Licht', 60, 60, 58, 'RentAll', 'GLP'),
  C('JDC-1 Cube -RentALL', 'Licht', 99, 60, 58, 'RentAll', 'GLP'),
  C('JDC-1 lang (6) -RentALL', 'Licht', 99, 60, 58, 'RentAll', 'GLP'),
  C('GLP X4-Bar-20 x4 -CAB', 'Licht', 131, 60, 58, 'CAB', 'GLP'),
  C('JDC-1 x6 -CAB', 'Licht', 120, 60, 58, 'CAB', 'GLP'),
  C('AF-2 -BBM', 'Licht', 80, 40, 95, 'BBM', 'Jem'),
  C('AF-1 -CAB', 'Licht', 44, 23, 58, 'CAB', 'Jem'),
  C('ZR44 -CAB', 'Licht', 78, 37, 34, 'CAB', 'Jem'),
  C('Das K - Annahme -Kraftklub', 'Licht', 320, 80, 200, 'Kraftklub', 'Kraftklub'),
  C('Look Viper NT -CAB', 'Licht', 57, 30, 36, 'CAB', 'Look Solutions'),
  C('Atomic 3000 LEDx8 -CAB', 'Licht', 120, 60, 72, 'CAB', 'Martin'),
  C('Atomic 3000 x4 no wheels -CAB', 'Licht', 120, 60, 36.5, 'CAB', 'Martin', { wheels: false }),
  C('Atomic 3000 x4 wheels -CAB', 'Licht', 120, 60, 50, 'CAB', 'Martin'),
  C('Atomic 3000 x8 -CAB', 'Licht', 120, 60, 73, 'CAB', 'Martin'),
  C('Mac Aura x6-CAB', 'Licht', 121, 60, 76, 'CAB', 'Martin'),
  C('Mac Axiom x2 -CAB', 'Licht', 119, 60, 95, 'CAB', 'Martin'),
  C('Mac Quantum w x2 -CAB', 'Licht', 80, 60, 100, 'CAB', 'Martin'),
  C('Mac Viper x2 -CAB', 'Licht', 122, 60, 100, 'CAB', 'Martin'),
  C('Mac Ultra x2 -CAB', 'Licht', 150, 60, 100, 'CAB', 'Martin'),
  C('Mac Ultra x1-CAB', 'Licht', 76, 60, 100, 'CAB', 'Martin'),
  C('MDG Tourpack -BBM', 'Licht', 103, 55, 92, 'BBM', 'MDG'),
  C('MDG Tourpack -CAB', 'Licht', 109, 60, 96, 'CAB', 'MDG'),
  C('BMFL Spot -BBM', 'Licht', 143, 35, 88, 'BBM', 'Robe'),
  C('Robe 2500p x1 -CAB', 'Licht', 72, 60, 113, 'CAB', 'Robe'),
  C('Robe 2500p x2 -CAB', 'Licht', 121, 60, 113, 'CAB', 'Robe'),
  C('Robe 2500w x1 -CAB', 'Licht', 72, 60, 105, 'CAB', 'Robe'),
  C('Robe 2500w x2 -CAB', 'Licht', 121, 60, 105, 'CAB', 'Robe'),
  C('Robin 100 LED Beam -CAB', 'Licht', 100, 59, 57, 'CAB', 'Robe'),
  C('Aramis -CAB', 'Licht', 189, 60, 82, 'CAB', 'Robert Juliat'),
  C('Korrigan -CAB', 'Licht', 133, 60, 63, 'CAB', 'Robert Juliat'),
  C('Q7 lang -BBM', 'Licht', 120, 60, 53, 'BBM', 'SGM'),
  C('SGM Q7 x4 -CAB', 'Licht', 60, 60, 75, 'CAB', 'SGM'),
  C('SGM Q7 x6 -CAB', 'Licht', 90, 60, 72, 'CAB', 'SGM'),
  C('SF Fan Fogger -CAB', 'Licht', 86, 40, 86, 'CAB', 'Smoke Factory'),
  C('SF Data II -CAB', 'Licht', 64, 35, 35, 'CAB', 'Smoke Factory'),
  C('SF TourHazer II -CAB', 'Licht', 53, 25, 41, 'CAB', 'Smoke Factory'),
  C('Intellipix -BBM', 'Licht', 120, 67, 73, 'BBM'),
  C('Sunstrips Sandwich -CAB', 'Licht', 220, 60, 125, 'CAB'),
  C('ETC S4 x8 -CAB', 'Licht', 119, 60, 83, 'CAB'),
  C('Q7 x4 -CAB', 'Licht', 60, 60, 75, 'CAB'),
  ...
  C('D8+ 0,5t -BBM', 'Rigging', 67, 55, 60, 'BBM', 'Motor'),
  C('D8+ 1t -BBM', 'Rigging', 80, 60, 60, 'BBM', 'Motor'),
  ...
  C('SkyPanel 120 x2-AED', 'Licht', 155, 60, 80, 'AED', 'ARRI'),
  C('Strike Array4 x4 - CAB', 'Licht', 100, 60, 80, 'CAB', 'Chauvet'),
  C('FR10 x2 -RentAll', 'Licht', 100, 60, 66, 'RentAll', 'GLP'),
  C('FR10 x6 -Motion', 'Licht', 110, 80, 113, 'Motion', 'GLP'),
  C('BMFL x2 -Motion', 'Licht', 145, 60, 88, 'Motion', 'Robe'),
