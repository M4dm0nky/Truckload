...
export const PRESET_CASES = [
  ...
  MLT('hof-mlt2-120', 'Traversenwagen MLT TWO 1,2 m – H.O.F.', 120, 36.8, 115),
  MLT('hof-mlt2-160', 'Traversenwagen MLT TWO 1,6 m – H.O.F.', 160, 41.8, 115),
  MLT('hof-mlt2-200', 'Traversenwagen MLT TWO 2,0 m – H.O.F.', 200, 46.7, 115),
  MLT('hof-mlt2-240', 'Traversenwagen MLT TWO 2,4 m – H.O.F.', 240, 50.8, 115),
  MLT('hof-mlt2-300', 'Traversenwagen MLT TWO 3,0 m – H.O.F.', 300, 57.7, 115),
  MLT('hof-mlt2-320', 'Traversenwagen MLT TWO 3,2 m – H.O.F.', 320, 60.1, 115),
  MLT('hof-mlt3-120', 'Traversenwagen MLT THREE 1,2 m – H.O.F.', 120, 34.7, 115),
  MLT('hof-mlt3-160', 'Traversenwagen MLT THREE 1,6 m – H.O.F.', 160, 39.4, 115),
  MLT('hof-mlt3-200', 'Traversenwagen MLT THREE 2,0 m – H.O.F.', 200, 44.4, 115),
  MLT('hof-mlt3-240', 'Traversenwagen MLT THREE 2,4 m – H.O.F.', 240, 48.9, 115),
  MLT('hof-mlt3-300', 'Traversenwagen MLT THREE 3,0 m – H.O.F.', 300, 55.6, 115),
  MLT('hof-mlt3-320', 'Traversenwagen MLT THREE 3,2 m – H.O.F.', 320, 58.0, 115),
  MLT('hof-mlt4-150', 'Traversenwagen MLT FOUR 1,5 m – H.O.F.', 150, 60.0, 115),
  MLT('hof-mlt4-240', 'Traversenwagen MLT FOUR 2,4 m – H.O.F.', 240, 71.5, 115),
  MLT('hof-mlt4-300', 'Traversenwagen MLT FOUR 3,0 m – H.O.F.', 300, 83.5, 115),
  MLT('prolyte-s36prf-122', 'Traversenwagen S36PRF fest 1,22 m – Prolyte', 122, 25.27, 115),
  MLT('prolyte-s36prf-244', 'Traversenwagen S36PRF fest 2,44 m – Prolyte', 244, 37.10, 115),
  MLT('prolyte-s36prf-305', 'Traversenwagen S36PRF fest 3,05 m – Prolyte', 305, 43.20, 115),
  MLT('prolyte-s36pra-122', 'Traversenwagen S36PRA flexibel 1,22 m – Prolyte', 122, 27.00, 115),
  MLT('prolyte-s36pra-244', 'Traversenwagen S36PRA flexibel 2,44 m – Prolyte', 244, 38.70, 115),
  MLT('prolyte-s36pra-305', 'Traversenwagen S36PRA flexibel 3,05 m – Prolyte', 305, 45.16, 115),
